    ...
    public static EncodedImage getResizedImage(String imgUrl, int toWidth, int toHeight) 
        ...
        try {
            ...
            try {
                ...
                // Logger.debug("resizeImage: failed to open FileConnection for '"
                // + file + "': " + e);
                throw new FileNotFoundException();
            }

            // Logger.debug("resizeImage: going to open InputStream..");
            in = fc.openInputStream();

            // Logger.debug("resizeImage: going to create byte[] data..");
            byte[] data = new byte[(int) fc.fileSize()];
